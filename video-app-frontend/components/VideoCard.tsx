...
//   thumbnailUrl?: string;
//   likes: number;
//   liked?: boolean; // optional prop to indicate liked status from parent
//   onLike: (id: string) => void; // pass id back to parent on like toggle
// }
...
//             source={{ uri: 'http://172.20.10.6:5000/api/video/stream/${video._id}' }}
//             useNativeControls
